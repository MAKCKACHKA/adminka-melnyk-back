...
exports.create = (req, res) => {
  upload.single("photo")(req, res, (err) => {
    ...
    const news = {
      ...
      // posterPhotoLocation: req.file ? req.file.filename : null,
      authorPhotoLocation: req.body.authorPhotoLocation || null,
      posterPhotoLocation: req.body.posterPhotoLocation || null,
      date: req.body.date,
